        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div className="rounded-xl border border-gray-700 bg-gray-800 p-6 shadow-lg">
                    ...
                    <p className="mt-2 text-4xl font-bold text-green-400">Rs. {dashboard.current_balance}</p>
                </div>
            
                {/* E-Sports Earnings */}
                <div className="rounded-xl border border-gray-700 bg-gray-800 p-6 shadow-lg">
                    <h3 className="text-sm font-medium text-gray-400">Total Game Earnings</h3>
                    <p className="mt-2 text-3xl font-bold text-blue-400">Rs. {dashboard.total_game_earnings}</p>
                ...
                <div className="rounded-xl border border-gray-700 bg-gray-800 p-6 shadow-lg">
                    ...
                    <p className="mt-2 text-3xl font-bold text-red-400">
                        Rs. {(parseFloat(dashboard.total_cafeteria_spend) + parseFloat(dashboard.total_bookshop_spend)).toFixed(2)}
                    </p>
