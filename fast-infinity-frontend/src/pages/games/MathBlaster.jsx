                            ...
                            <>
                                ...
                                <div className="flex gap-2 w-full">
                                    <input
                                        ...
                                        className="flex-1 min-w-0 bg-gray-700 border border-gray-600 focus:border-blue-500 rounded-lg px-4 py-3 text-white text-xl font-bold text-center outline-none tabular-nums transition"
                                        autoComplete="off"
                                        disabled={!!feedback}
                                    />
                                    <button
                                        ...
                                        className="flex-shrink-0 px-5 py-3 bg-blue-600 hover:bg-blue-500 disabled:opacity-40 disabled:cursor-not-allowed text-white font-bold rounded-lg transition"
                                    >→</button>
                                </div>
                ...
                <div className="flex flex-col gap-4 flex-1 min-w-0">
                    ...
                    <div className="rounded-xl border border-gray-700 bg-gray-800 p-6">
                        ...
                        <p className="text-sm text-gray-500 mt-2">
                            ≈ <span className="text-green-400">Rs. {(totalScore * 2).toFixed(2)}</span> if you cash out now
                        </p>
                    </div>
