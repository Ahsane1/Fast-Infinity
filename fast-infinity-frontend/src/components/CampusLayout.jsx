                ...
                {isAboutOpen && (
                    ...
                    >
                        ...
                        <div className="relative z-10 flex w-full flex-col items-center justify-center pt-2 pb-20 text-left">
                            ...
                            {/* ======================================= */}
                            {/* SIMPLE PROFILE CARD: SHEIKH AHSAN OMER  */}
                            {/* ======================================= */}
                            <div className="w-full max-w-5xl flex justify-center mt-4">
                                <motion.div 
                                    whileHover={{ y: -4 }}
                                    className="flex flex-col items-center w-full max-w-sm rounded-[2.5rem] border border-white/10 bg-white/5 p-8 backdrop-blur-md shadow-2xl relative overflow-hidden group"
                                >
                                    ...
                                    <div className="relative z-10 flex flex-col items-center w-full">
                                        ...
                                        {/* Profile Picture */}
                                        <div className="h-32 w-32 rounded-full overflow-hidden border-2 border-white/20 mb-6 shadow-inner bg-slate-800">
                                            {/* CHANGE 'ahsan-profile.png' IF YOUR IMAGE HAS A DIFFERENT EXTENSION */}
                                            <img src="/ahsan-profile.jpg" alt="Ahsan Omer" className="h-full w-full object-cover" />
                                        </div>
                                        ...
                                        <div className="flex items-center space-x-2 mt-4 mb-8">
                                            ...
                                            <span className="text-sm font-medium text-gray-400">Sophomore</span>
                                        </div>
                                        ...
                                        <div className="flex space-x-4 w-full">
                                            {/* GitHub Button */}
                                            <a 
                                                href="https://github.com/Ahsane1" 
                                                target="_blank" 
                                                rel="noopener noreferrer" 
                                                className="flex-1 flex items-center justify-center space-x-2 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 py-3 transition-colors"
                                            >
                                            ...
                                            {/* LinkedIn Button */}
                                            <a 
                                                href="https://www.linkedin.com/in/ahsan-omer-b7710b301" 
                                                target="_blank" 
                                                rel="noopener noreferrer" 
                                                className="flex-1 flex items-center justify-center space-x-2 rounded-xl bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/20 py-3 transition-colors"
                                            >
