...
const GAMES = [
    ...
    },
    {
        ...
        name:        '2048',
        emoji:       '🟦',
        description: 'Slide and merge tiles. Reach 2048 to win. Score converts directly to campus cash.',
        status:      'available',
        path:        '/esports/2048',
        tag:         'Live',
        tagCls:      'bg-green-900 text-green-300 border border-green-700',
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                {GAMES.map(game => (
                    ...
                    >
                        ...
                        {!game.tag && (
                            <span className="absolute top-4 right-4 text-xs text-gray-600 font-medium">Soon</span>
                        )}
